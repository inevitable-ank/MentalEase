...
const MoodTrack = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://mentalease.onrender.com/api/moods/${username}`)
  ...
  const handleMoodSelect = (selectedMood) => {
    ...
    axios.post(`https://mentalease.onrender.com/api/moods/${username}`, { date: selectedDate, mood: selectedMood })
      .then(response => {
