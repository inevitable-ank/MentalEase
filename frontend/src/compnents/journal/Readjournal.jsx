...
const Readjournal = () => {
    ...
    useEffect(() => {
        const fetchJournals = async () => {
            try {
                const response = await axios.get(`https://mentalease.onrender.com/${username}/journals`);
    ...
    const confirmDelete = async () => {
        try {
            await axios.delete(`https://mentalease.onrender.com/journal-delete/${username}/${journalToDelete}`);
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    {journals.map((journal) => {
                        const coverImage = journal.coverPicture ? `https://mentalease.onrender.com/${journal.coverPicture}` : defaultCoverImage;
